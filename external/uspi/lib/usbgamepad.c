...
boolean USBGamePadDeviceConfigure (TUSBDevice *pUSBDevice)
{
    ...
    {
        UspiLogWrite(FromUSBPad, LOG_ERROR, "Cannot get HID report descriptor");
    ...
    {
        UspiLogWrite(FromUSBPad, LOG_ERROR, "Cannot set configuration");
    ...
    if (pThis->m_ucAlternateSetting != 0)
    {
        ...
        {
            UspiLogWrite(FromUSBPad, LOG_ERROR, "Cannot set interface");
