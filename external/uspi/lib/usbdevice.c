...
boolean USBDeviceInitialize (TUSBDevice *pThis)
{
	...
	{
        UspiLogWrite(FromDevice, LOG_ERROR, "Cannot get device descriptor (short)");
	...
	{
        UspiLogWrite(FromDevice, LOG_ERROR, "Invalid device descriptor");
	...
	{
        UspiLogWrite(FromDevice, LOG_ERROR, "Cannot get device descriptor");
	...
	{
        UspiLogWrite(FromDevice, LOG_ERROR, "Too many devices");
	...
	{
        UspiLogWrite(FromDevice, LOG_ERROR,
	...
	{
        UspiLogWrite(FromDevice, LOG_ERROR, "Cannot get configuration descriptor (short)");
	...
	{
        UspiLogWrite(FromDevice, LOG_ERROR, "Invalid configuration descriptor");
	...
	if (DWHCIDeviceGetDescriptor (pThis->m_pHost, pThis->m_pEndpoint0,
	    ...
	    != (int) nTotalLength)
	{
        UspiLogWrite(FromDevice, LOG_ERROR, "Cannot get configuration descriptor");
...
boolean USBDeviceConfigure (TUSBDevice *pThis)
{
	...
	{
        UspiLogWrite(FromDevice, LOG_ERROR, "Cannot set configuration (%u)",
...
void USBDeviceSetAddress (TUSBDevice *pThis, u8 ucAddress)
{
	...
	//UspiLogWrite (FromDevice, LOG_DEBUG, "Device address set to %u", (unsigned) pThis->m_ucAddress);
}
