...
function build_x86
    ...
    i686-elf-gcc -T kernel/x86/linker.ld -o out/x86/raptor.bin -ffreestanding -O2 -nostdlib out/x86/boot.o out/x86/entry.o
end
...
function qemu_x86
    qemu-system-i386 -kernel out/x86/raptor.bin
end
